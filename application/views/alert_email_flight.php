...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">#ko_textBlock_7 .links-color a:visited, #ko_textBlock_7 .links-color a:hover {color: #3f3f3f;color: #3f3f3f;text-decoration: underline;}
    ...
    <body bgcolor="#ffffff" text="#919191" alink="#cccccc" vlink="#cccccc" style="margin: 0;padding: 0;background-color: #ffffff;color: #919191;">
        <center>
                                        ...
                                        <tr>
                                            <td valign="top" align="center">
                                                <div class="mobile-full" style="display: inline-block; max-width: 258px; vertical-align: top; width: 100%;"> 
                                                    <img width="258" vspace="0" hspace="0" border="0" alt="" style="border: 0px;display: block;width: 100%;max-width: 258px;" src="https://mosaico.io/srv/f-sinvz37/img?src=https%3A%2F%2Fmosaico.io%2Ffiles%2Fsinvz37%2Flogo.png&amp;method=resize&amp;params=258%2Cnull"></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <table class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#ffffff" style="background-color: #ffffff;" id="ko_titleBlock_4">
                <tbody>
                    <tr>
                        <td class="vb-outer" align="center" valign="top" bgcolor="#ffffff" style="padding-left: 9px;padding-right: 9px;background-color: #ffffff;">
                            <div class="oldwebkit" style="max-width: 570px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td bgcolor="#ffffff" align="center" style="background-color: #ffffff; font-size: 22px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f; text-align: center;">
                                                <span>Message From Agile Vihar</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <table class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#ffffff" style="background-color: #ffffff;" id="ko_textBlock_7">
                <tbody>
                    <tr>
                        <td class="vb-outer" align="center" valign="top" bgcolor="#ffffff" style="padding-left: 9px;padding-right: 9px;background-color: #ffffff;">
                            <div class="oldwebkit" style="max-width: 570px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;">
                                                <p style="margin: 1em 0px;margin-top: 0px;">Hello, <?= $user_data['first_name'] . ' ' . $user_data['last_name'] ?> </p>
                                                <p style="margin: 1em 0px;margin-bottom: 0px;">Your alert for <?= $flight_provider['provider_name'] ?> Airline is matched.</p>
                                                <p style="margin: 1em 0px;margin-bottom: 0px;">Your expected price: $<?= $alert_data['expected_price'] ?></p>
                                                <p style="margin: 1em 0px;margin-bottom: 0px;">Current price: $<?= $current_price ?></p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <table class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#ffffff" style="background-color: #ffffff;" id="ko_buttonBlock_5">
                <tbody>
                    <tr>
                        <td class="vb-outer" align="center" valign="top" bgcolor="#ffffff" style="padding-left: 9px;padding-right: 9px;background-color: #ffffff;">
                            <div class="oldwebkit" style="max-width: 570px;">
                                        ...
                                        <tr>
                                            <td valign="top" bgcolor="#ffffff" align="center" style="background-color: #ffffff;">
                                                <table cellpadding="0" border="0" align="center" cellspacing="0" class="mobile-full">
                                                    <tbody>
                                                        <tr>
                                                            <td width="auto" valign="middle" bgcolor="#ffffff" align="center" height="50" style="font-size: 22px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f; font-weight: normal; padding-left: 14px; padding-right: 14px; background-color: #ffffff; border-radius: 4px;">
                                                                <a href="<?= base_url('places/index/' . $flight_details['destination_id']) ?>" target="_blank"><button type="button" class="btn btn-success">Check Near By Places</button></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
